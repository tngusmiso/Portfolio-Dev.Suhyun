...
| 기간 | 프로젝트 명 | 내용     |
|:----|:---------|:--------|
| 2019.12. - 2020.02. | Nexters 16th | 개발자와 디자이너의 IT 연합동아리 Nexters에서 개발자로 활동 <br> 대학생 기준 방학기간 2달동안 하나의 프로젝트 완수를 목표로 함. <br> **활동 프로젝트** : [옛다](#ios-옛다) <br> http://teamnexters.com/ |
